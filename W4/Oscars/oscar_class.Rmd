...
# seeing whether the more number of nominations is suggestive of higher chance of winning for best picture category
...
# choice = column in the df indicating which choice out of all alternatives is selected (ie. the selected alternative)
...
# results in descending order from 2007. 4th value is year 2004, where the movie that won had a 0.03 probability of winning
...
for(i in 1960:2006) {
  ...
  M <- mlogit(formula = Ch ~ Pic + Gm1 + Gm2 + PrNl + PrWl - 1, data = D)
