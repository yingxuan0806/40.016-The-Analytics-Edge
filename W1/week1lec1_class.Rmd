...
```{r}
x + y
# if one variable is only of one value, it is used as an addition to all elements of the vector variable
# if both variables are vectors of different length, addition is not permitted
...
# returns maximum value of each index no matter which individual vector it is from
# length of vector returned is equivalent to the longest vector in the argument
